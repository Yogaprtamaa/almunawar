        ...
        >
            <div className="relative mb-6 aspect-[4/5] overflow-hidden bg-stone-100">
                {image ? (
                    ...
                    <div className="size-full bg-gradient-to-br from-[#1F3A2B]/10 to-[#A98446]/10" />
                )}
            </div>
            <span className="mb-2 block text-[10px] font-semibold uppercase tracking-widest text-[#A98446]">
                {program.category}
            </span>
            <h3 className="mb-3 font-serif text-lg font-medium text-[#0F1A13] transition-colors group-hover:text-[#1F3A2B]">
                {program.title}
            </h3>
